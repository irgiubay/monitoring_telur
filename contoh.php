...
if ($filterTahun && $filterBulan) {
    ...
    // Jika tidak ada filter, ambil data total dari seluruh database
    $queryTotal = "SELECT 
                    SUM(jumlah_produksi) AS total_jumlah_produksi, 
                    SUM(jumlah_cacat) AS total_telur_cacat, 
                    SUM(total_produksi) AS total_total_produksi 
...
$dataTotal = $resultTotal->fetch_assoc() ?: ['total_jumlah_produksi' => 0, 'total_telur_cacat' => 0, 'total_total_produksi' => 0];
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="data_produksi.php">Data Produksi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="user_teraktif.php">User Teraktif</a>
                    </li>
                </ul>
    ...
    <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin'): ?>
        <div class="container mt-3">
            <a href="admin_panel.php" class="btn btn-secondary mb-3">
    ...
    <div class="container mt-3">
        <!-- Tombol Import hanya satu di sini -->
        ...
        <form action="kirimdata.php" method="post" style="display:inline;">
            <button type="submit" class="btn btn-success" onclick="return confirm('Kirim data ke Google Sheet?')">
